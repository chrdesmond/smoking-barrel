...
export default function Teams() {
    ...
    return (
        <>
            <div className="lg:bg-[url('https://www.gordi.id/cdn/shop/articles/img_flavorperception_2048x.jpg?v=15537443540')] bg-yellow-800 w-full lg:h-[370px] h-[130px] bg-no-repeat bg-center bg-cover">
